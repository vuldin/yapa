...
import {
  SALIENCE_START,
  USERNAME,
  CONTRADICTION_DISTANCE_THRESHOLD,
  CONTRADICTION_MAX_RESULTS,
} from '../config.js';
...
export function findConflicts(
  ...
  threshold: number = CONTRADICTION_DISTANCE_THRESHOLD,
  maxResults: number = CONTRADICTION_MAX_RESULTS,
): ConflictRecord[] {
  return candidates
